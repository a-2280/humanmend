...
export default function SoloOrGroup({ isOpen, onClose, onSuccess }) {
        ...
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <div>
            <p className="body-text text-cream">
              Whether you&apos;re navigating a complex case, ethical
              uncertainty, or simply want to sharpen your clinical thinking,
              consultation offers structured support from another experienced
              provider. We look forward to getting in touch and helping you in
